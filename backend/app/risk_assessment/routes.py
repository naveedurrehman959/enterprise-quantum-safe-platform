...
def dashboard():
    ...
    result = RiskAssessmentService.dashboard_summary()
...
def analyze_algorithm():
    ...
    errors = RiskAssessmentSchema().validate(data)
    ...
    create_audit_log(
        ...
        status="SUCCESS",
        description=f"Risk analysis performed for {data['algorithm']}"
    )
...
@risk_bp.route("/inventory", methods=["GET"])
@jwt_required()
def inventory():
