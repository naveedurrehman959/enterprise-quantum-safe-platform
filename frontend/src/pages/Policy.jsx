...
/*
 * Convert the backend policy response into the
 * format required by the frontend.
 */
const normalizePolicies = (data) => {
    ...
    return Object.values(algorithmMap);
};

/*
 * Fetch policy information from the backend.
 *
 * This function is outside the component so it does not
 * create a React hook dependency problem.
 */
const fetchPolicyData = async () => {
    ...
    return {
        data,
        policies: normalizePolicies(data),
    };
};
    ...
    useEffect(() => {
        ...
        const loadInitialPolicy = async () => {
            try {
                ...
                setLocalPolicies(result.policies);
                setError("");
            } catch (error) {
                if (cancelled) {
                    return;
        ...
        return (
            <Box>
                ...
                >
                    ...
                    policy, algorithm enforcement and
                ...
                <Grid size={{ xs: 12 }}>
                    ...
                    >
                        ...
                        <Typography
                            ...
                            sx={{ mb: 3 }}
                        >
                            Configure which cryptographic
                            algorithms are permitted,
                            blocked, or require migration.
                        </Typography>

                        {localPolicies.length === 0 ? (
                            <Alert severity="info">
                                No algorithm policies are
                                currently available.
                            </Alert>
                        ) : (
                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            ...
                            sx={{ mb: 3 }}
                        >
                            Algorithms prohibited because
                            they do not meet enterprise
                    ...
                    <Grid size={{ xs: 12 }}>
                        ...
                        >
                            ...
                            <Typography
                                ...
                                sx={{ mb: 3 }}
                            >
                                Algorithms permitted only
                                under defined security
